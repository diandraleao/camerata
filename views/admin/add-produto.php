		...
		<main>
			...
			<form class="form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input type="text" class="form-control" id="nome" placeholder="Insira o nome do produto">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input type="date" class="form-control" id="descricao" placeholder="Insira a descrição do produto">
					</div>
				</div>

				<div class="form-group">
					<label for="horario" class="col-sm-2 control-label">Imagem: </label>
					<div class="col-sm-8">
						<input type="file" class="form-control" id="horario" placeholder="">
					</div>
				</div>
